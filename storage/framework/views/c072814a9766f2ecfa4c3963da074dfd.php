...
<head>
  ...
  <script src="<?php echo e(asset('js/funzione_sottomenu.js')); ?>" defer></script>
  <script src="<?php echo e(asset('js/api_esterne.js')); ?>" defer></script>
  <script src="<?php echo e(asset('js/funzioni_index_home.js')); ?>"defer></script>
...
<header>
  <nav class="nav_sup">
    ...
    <div id="accesso">
      ...
      <div class="button-accesso">
      <a>Iscriviti |</a>
      <a>Accedi</a>
      </div>
      <div id="modal-view" class="hidden">
        <div class="modal-content">
          <a id="X"><img src="chiudi.png"/></a>
          ...
          <div class="accedi-con">
            ...
            <div class="testo_altro">
              <p>Oppure iscriviti con <a href="iscrizione.php">E-mail</a></p>
            </div>
            <div class="testo_account">
              <p>Hai già un account? <a href="accesso.php">Accedi</a></p>
            </div>
            <div id="divisore"></div>
      ...
      <a href="logout.php" class="button-vendita">Logout</a>
      <?php endif; ?>
    </div>
      ...
      <div class="submenu">
        <div class="submenu-left">
          ...
          <a data-subsubmenu="intimodonna">
            <img src="intimo.png" alt="Icona Intimo" />
            Intimo e Pigiami
          </a>
          <a data-subsubmenu="beautydonna">
            <img src="beauty.png" alt="Icona Beauty" />
            Bellezza
          </a>
        </div>
...
<div id="flex-container">
  <div class="box">
    <div class="div-img">
      <img src="fotofeed1.jpeg" />
      <div class="likes" data-likes="43">
        <img src="like.png" alt="cuore" />
        <span>43</span>
      </div>
    </div>
    <div class="div-testo">
...
<div class="cerchio-vinted">
  <img src="soldi.png" alt="Icona Soldi" />
</div>
...
<div class="footer-middle">
  ...
  <div class="app-download">
    ...
    <img src="googleplay.png" class="app-badge"></a>
    ...
    <img src="appstore.png"  class="app-badge"></a>
  </div>
</div>
...
</html><?php /**PATH /Users/andreapagliarello/hw02/resources/views/index.blade.php ENDPATH**/ ?>