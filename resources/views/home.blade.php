<head>
  ...
  <link rel="stylesheet" href="{{ url('css/menuhome.css') }}">
  <script src="{{ url('js/home.js') }}" defer></script>
  <script src="{{ url('js/funzione_profilo_carrello.js') }}" defer></script>
  <script src="{{ url('js/funzione_sottomenu.js') }}" defer></script>
  <script src="{{ url('js/api_esterne.js') }}" defer></script>
  <script src="{{ url('js/funzioni_index_home.js') }}" defer></script>
  ...
  <nav class="nav_sup">
    ...
    <div id="accesso">
      ...
      <div id="collegamento-menu" class="hidden">
        @if(session('user_id'))
          <div class="menu-item">
            <a href="{{ url('profilo') }}">Il mio profilo</a>
          </div>
          <div class="menu-item">
            <a href="{{ url('carrello') }}">Il mio carrello</a>
          </div>
        @else
          <div class="modal-content">
            <a id="X"><img src="{{ url('image/chiudi.png') }}"/></a>
            ...
            <div class="accedi-con">
              ...
              <div class="accedi-con-titolo">
                <div>
                <img src="{{ url('image/ios-apple.svg') }}" />
              ...
              <div class="testo_altro">
                <p>Oppure iscriviti con <a href="{{ url('register') }}">E-mail</a></p>
              </div>
      ...
      @if(session('user_id'))
        <a href="{{ url('logout') }}" class="button-vendita">Logout</a>
      @else
      ...
      <div class="submenu">
        <div class="submenu-left">
          <a data-subsubmenu="tuttidonna" class="active">
            <img src="{{ url('image/tutti.png') }}" alt="Icona Tutti" />
            Tutti
          </a>      
          <a data-subsubmenu="abbigliamentodonna">
            <img src="{{ url('image/vestiti.png') }}" alt="Icona Abbigliamento" />
            Abbigliamento
          </a>
          <a data-subsubmenu="scarpeedonna">
            <img src="{{ url('image/scarpe.png') }}" alt="Icona Scarpe" />
            Scarpe
          </a>
          <a data-subsubmenu="borseaccessoridonna">
            <img src="{{ url('image/borse.png') }}" alt="Icona Borse" />
            Borse e Accessori
          </a>
          <a data-subsubmenu="intimodonna">
            <img src="{{ url('image/intimo.png') }}" alt="Icona Intimo" />
            Intimo e Pigiami
          </a>
          <a data-subsubmenu="beautydonna">
            <img src="{{ url('image/beauty.png') }}" alt="Icona Beauty" />
            Bellezza
          </a>
        </div>
      ...
      <div class="submenu">
        <div class="submenu-left">
          ...
          <a data-subsubmenu="accessoriuomo">
            <img src="{{ url('image/accessori.png') }}" alt="Icona Accessori" />
            Accessori
          </a>
      ...
      <div class="submenu">
        <div class="submenu-left">
          ...
          <a data-subsubmenu="giocattolibambini">
              <img src="{{ url('image/giocattoli.png') }}" alt="Icona Giocattoli" />
              Giocattoli
          </a>
          ...
          <a data-subsubmenu="pannibambini">
              <img src="{{ url('image/pannolini.png') }}" alt="Icona Pannolini" />
              Pannolini e Cura
          </a>
        </div>
      ...
      <div class="submenu">
        <div class="submenu-left">
          ...
          <a data-subsubmenu="arredamentocasa">
              <img src="{{ url('image/arredamento.png') }}" alt="Icona Arredamento" />
              Arredamento Casa
          </a>
          <a data-subsubmenu="elettrodomesticicasa">
              <img src="{{ url('image/elettrodomestici.png') }}" alt="Icona Elettrodomestici" />
              Elettrodomestici
          </a>
          <a data-subsubmenu="illuminazionecasa">
              <img src="{{ url('image/illuminazione.png') }}" alt="Icona Illuminazione" />
              Illuminazione
          </a>
          <a data-subsubmenu="decocasa">
              <img src="{{ url('image/decorazioni.png') }}" alt="Icona Decorazioni" />
              Decorazioni Casa
          </a>
          <a data-subsubmenu="tavola">
              <img src="{{ url('image/tavola.png') }}" alt="Icona Tavola" />
              Tavola e Cucina
          </a>
    ...
    <div class="hidden" data-submenu="elettronica">
      <div class="submenu">
        ...
        <a data-subsubmenu="smartphone">
            <img src="{{ url('image/smartphone.png') }}" alt="Icona Smartphone" />
            Smartphone
        </a>
        <a data-subsubmenu="computer">
            <img src="{{ url('image/computer.png') }}" alt="Icona Computer" />
            Computer
        </a>
        <a data-subsubmenu="televisori">
            <img src="{{ url('image/tv.png') }}" alt="Icona Televisori" />
            Televisori
        </a>
        <a data-subsubmenu="audio">
            <img src="{{ url('image/audio.png') }}" alt="Icona Audio" />
            Audio
        </a>
        <a data-subsubmenu="fotocamere">
            <img src="{{ url('image/fotocamera.png') }}" alt="Icona Fotocamere" />
            Fotocamere
        </a>
    ...
    <div class="hidden" data-submenu="intrattenimento">
      <div class="submenu">
        ...
        <a data-subsubmenu="film">
            <img src="{{ url('image/film.png') }}" alt="Icona Film" />
            Film
        </a>
        <a data-subsubmenu="musica">
            <img src="{{ url('image/musica.png') }}" alt="Icona Musica" />
            Musica
        </a>
        <a data-subsubmenu="giochi">
            <img src="{{ url('image/giochi.png') }}" alt="Icona Giochi" />
            Giochi
        </a>
        <a data-subsubmenu="libri">
            <img src="{{ url('image/libri.png') }}" alt="Icona Libri" />
            Libri
        </a>
        <a data-subsubmenu="eventi">
            <img src="{{ url('image/eventi.png') }}" alt="Icona Eventi" />
            Eventi
        </a>
    ...
    <div class="hidden" data-submenu="animali">
      <div class="submenu">
        ...
        <a data-subsubmenu="cani">
            <img src="{{ url('image/cani.png') }}" alt="Icona Cani" />
            Cani
        </a>
        <a data-subsubmenu="gatti">
            <img src="{{ url('image/gatti.png') }}" alt="Icona Gatti" />
            Gatti
        </a>
        <a data-subsubmenu="pesci">
            <img src="{{ url('image/pesci.png') }}" alt="Icona Pesci" />
            Pesci
        </a>
        <a data-subsubmenu="uccelli">
            <img src="{{ url('image/uccelli.png') }}" alt="Icona Uccelli" />
            Uccelli
        </a>
        <a data-subsubmenu="piccoli-animali">
            <img src="{{ url('image/piccoli-animali.png') }}" alt="Icona Piccoli Animali" />
            Piccoli Animali
        </a>
        </div>
...
<section class="section1">
  <img src="{{ url('image/home2.png') }}" class="home">
...
<div id="flex-container">
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed1.jpeg') }}" />
      <div class="likes" data-likes="43">
        <img src="{{ url('image/like.png') }}" alt="cuore" />
        <span>43</span>
      </div>
    </div>
    <div class="div-testo">
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed2.jpeg') }}" />
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed3.jpeg') }}" />
      <div class="likes" data-likes="24">
        <img src="{{ url('image/like.png') }}" alt="cuore" />
        <span>24</span>
      </div>
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed4.jpeg') }}" />
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed5.jpeg') }}" />
...
<div id="flex-container">
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed6.jpeg') }}" />
      <div class="likes" data-likes="43">
        <img src="{{ url('image/like.png') }}" alt="cuore" />
        <span>43</span>
      </div>
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed7.jpeg') }}" />
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed8.jpeg') }}" />
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed9.jpeg') }}" />
      <div class="likes" data-likes="43">
        <img src="{{ url('image/like.png') }}" alt="cuore" />
        <span>43</span>
      </div>
  ...
  <div class="box">
    <div class="div-img">
      <img src="{{ url('image/fotofeed10.jpeg') }}" />
      <div class="likes" data-likes="43">
        <img src="{{ url('image/like.png') }}" alt="cuore" />
        <span>43</span>
      </div>
...
<div class="hidden">
  <div id="flex-container-extra">
    <div class="box">
      <div class="div-img">
      <img src="{{ url('image/fotofeed11.jpeg') }}" />
    ...
    <div class="box">
      <div class="div-img">
      <img src="{{ url('image/fotofeed12.jpeg') }}" />
    ...
    <div class="box">
      <div class="div-img">
      <img src="{{ url('image/fotofeed13.jpeg') }}" />
        <div class="likes" data-likes="14">
          <img src="{{ url('image/like.png') }}" alt="cuore" />
          <span>14</span>
        </div>
    ...
    <div class="box">
      <div class="div-img">
      <img src="{{ url('image/fotofeed14.jpeg') }}" />
    ...
    <div class="box">
      <div class="div-img">
      <img src="{{ url('image/fotofeed15.jpeg') }}" />
...
<div class="box-recensioni">
  ...
  <a href="{{ url('recensioni') }}" class="link-recensioni">Scrivi una recensione</a>
</div>


<div class="cerchio-vinted">
  <img src="{{ url('image/soldi.png') }}" alt="Icona Soldi" />
</div>
  ...
  <div class="footer-middle">
    <div class="social-icons">
      <a href="https://www.facebook.com/vinted">
        <img src="{{ url('image/facebook.png') }}" alt="Facebook" />
      </a>
      <a href="https://www.linkedin.com/company/vinted">
        <img src="{{ url('image/linkedin.png') }}" alt="LinkedIn" />
      </a>
      <a href="https://www.instagram.com/vinted/">
        <img src="{{ url('image/instagram.png') }}" alt="Instagram" />
      </a>
    </div>
    <div class="app-download">
      <a href="https://play.google.com/store/apps/details?id=fr.vinted&referrer=adjust_reftag%3DcELWNEws5VQE6%26utm_source%3DDesktop_vinted.fr%257Capp_landing%257Clongterm%257Cbadge_android%257Cdownload%26utm_medium%3Dapp_landing">
        <img src="{{ url('image/googleplay.png') }}" class="app-badge" alt="Google Play Store" />
      </a>
      <a href="https://apps.apple.com/us/app/vinted-sell-vintage-clothes/id632064380?mt=8&pt=1493347&ct=Desktop_vinted.fr%7Capp_landing%7Clongterm%7Cbadge_ios%7Cdownload">
        <img src="{{ url('image/appstore.png') }}" class="app-badge" alt="App Store" />
      </a>
    </div>
  </div>
