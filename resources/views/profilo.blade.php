...
<section class="profile-section">
  <div class="profile-header">
    <img src="{{ url('image/profile.jpg') }}" alt="Profile Picture" class="profile-pic" />
    <div class="profile-info">
    <h2 class="username">{{ $user->name }} {{ $user->surname }}</h2>

    <p class="no-reviews">{{ $user->username }}</p>

      <div class="info">
        <div>
          <p>📍 Italia</p>
          <p>⏱️ Ultima visita 24 secondi fa</p>
          <p>📡 <a href="#">0 follower</a>, <a href="#">0 seguiti</a></p>
        </div>
        <div>
          <p>✔️ Google</p>
          <p>✔️ E-mail</p>
    ...
    <button class="edit-profile">✏️ Modifica profilo</button>
  </div>

  <div class="tabs">
    <button class="active">Preferiti</button>
